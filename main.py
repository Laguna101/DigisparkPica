...
class Main:
    def __init__(self):
        self.source_mail = 'falencar368@gmail.com'
        self.source_pass = 'felipe101x!'
        self.dest_mail = ['kovinevmv@gmail.com', 'falencar368@gmail.com', 'felipe1227ferreiralemos@gmail.com']
